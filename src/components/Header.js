...
const navigation = [
    ...
    { name: "Projects", href: "/tes" },
    { name: "Calendar", href: "/safsdf" },
];
                                                    ...
                                                    className={({
                                                        ...
                                                        return (
                                                            ...
                                                            (!isActive
                                                                ...
                                                                : "bg-gray-950 text-white no-underline")
                                                        );
                                                    }}
                                                    aria-current={
                                                        item.current
                                        ...
                                        <div>
                                            <Menu.Button className="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                                                ...
                                                <img
                                                    ...
                                                    src="https://1.gravatar.com/avatar/3afb2f28b1cece9c0af626b8a0cf4fd69e0017c84577d0453a8e402eeebc8f16?size=128"
                                                    alt=""
                                                />
                                            </Menu.Button>
                                        </div>
